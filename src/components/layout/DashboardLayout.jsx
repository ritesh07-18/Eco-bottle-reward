...
import { Gift, History, LayoutDashboard, LogOut, Recycle, ReceiptText, SearchCheck } from 'lucide-react';
...
const canteenLinks = [
  { to: '/canteen/dashboard', label: 'Verify Coupons', icon: SearchCheck },
  { to: '/canteen/transactions', label: 'Transactions', icon: ReceiptText },
];
