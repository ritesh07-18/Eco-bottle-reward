...
insert into public.redemption_options (points, discount)
values (50, 10), (100, 25), (200, 60), (300, 100)
on conflict (points) do update set discount = excluded.discount, updated_at = now();
